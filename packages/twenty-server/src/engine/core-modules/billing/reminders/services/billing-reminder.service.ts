...
export class BillingReminderService {
  ...
  private buildReminderEmail({
    ...
    switch (reminder.type) {
      case 'trial-ending':
        return {
          subject: msg`Your Cybernetics trial is ending soon`,
      ...
      case 'trial-converting':
        return {
          subject: msg`A heads up before your Cybernetics trial ends`,
      ...
      case 'subscription-renewing':
        return {
          subject: msg`Your Cybernetics plan renews soon`,
