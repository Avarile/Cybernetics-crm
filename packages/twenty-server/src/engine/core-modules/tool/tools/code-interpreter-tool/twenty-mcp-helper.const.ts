...
export const TWENTY_MCP_HELPER = `# Auto-injected Cybernetics MCP helper - provides access to Cybernetics tools
import os
import json
...
class TwentyMCP:
    """Helper for calling Cybernetics tools from sandboxed code.
    ...
    def call_tool(self, name: str, arguments: dict = None):
        """
        Call any Cybernetics tool by name.
        ...
        if not self._available:
            raise RuntimeError('Cybernetics MCP bridge not available. Missing requests library or credentials.')
