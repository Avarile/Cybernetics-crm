export const buildMcpServerInstructions = (
  ...
  [
    `You are an AI assistant for a Cybernetics CRM workspace.`,
    ...
    `  http_request is ONLY for external third-party APIs, never for Cybernetics's own data.`,
    ``,
